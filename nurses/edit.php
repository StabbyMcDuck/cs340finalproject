...
if (!$statement->bind_param('i', $nurse_id)) {
...
while ($statement->fetch()) {
    ...
    <div class="container">
        ...
        <form action="update.php" class="form-signin" id="form" method="post">
            <h2 class="form-signin-heading">Edit Nurse</h2>
            ...
            <button class="btn btn-lg btn-primary btn-block" type="submit">Update Nurse</button>
